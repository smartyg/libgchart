...
MyWindow::MyWindow()
{
	...
	std::map<const float, const float> map1A = {{0,0},{1,10},{2,10},{3,15},{4,5},{5,10},{5,11},{6,0}};
	std::map<const float, const float> map1B = {{0,0},{1,11},{2,11},{3,16},{4,6},{5,9},{5,10},{6,0}};
	...
	this->chart.addY1Chart (GchartChart::Type::LINEAR, 1, {1, 0, 0} , map1A, nullptr);
	this->chart.addY1Chart (GchartChart::Type::LINEAR, 2, {0, 0, 1} , map1B, nullptr);
